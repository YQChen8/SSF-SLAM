...
if __name__ == '__main__':
    ...
    dataset_path = './results/record2022_0315_1209/rm_egoV_fg/SF/'
    npoints = 20000
    ...
    for iCnt, data in enumerate(test_dataset): 
        ...
        new_sf = calc_coarse_flow_from_bev([torch_fgrnd_s, torch_coarse_flow, torch_fgrnd_t])
        np_pc5 = fgrnd_s + ego_flow[fgrnd_inds_s, :]
        ego_flow[fgrnd_inds_s, :] = new_sf[0].T

        np_pc3 = fgrnd_s + new_sf[0].T
