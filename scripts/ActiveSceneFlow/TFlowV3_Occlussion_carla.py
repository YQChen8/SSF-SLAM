...
class TFlow(nn.Module):
    def __init__(self, npoint=8192, use_leaky=True):
        ...
        # self.flow4_r = RefineFlowRegressor(nsample=16, in_channel=512, feat_channel=512, voxel_size=0.5, resolution=3, mlp=[256, 256], feat_mlp=[256, 256], flow_mlp=[256, 256], use_flow=False, use_flow_feats=False)

        self.su3 = PointNetSetUpConv(nsample=16, radius=2.4, f1_channel=256, f2_channel=512, mlp=[256, 256], mlp2=[256,256])
        self.flow3_r = RefineFlowRegressor(nsample=16, in_channel=256, feat_channel=256, voxel_size=0.4, resolution=3,  mlp=[256, 256], feat_mlp=[256, 256], flow_mlp=[128, 128], use_flow=False, use_flow_feats=False)

        self.su2 = PointNetSetUpConv(nsample=16, radius=2.4, f1_channel=128, f2_channel=256, mlp=[128, 128], mlp2=[128,128])
        self.flow2_r = RefineFlowRegressor(nsample=16, in_channel=128, feat_channel=128, voxel_size=0.25, resolution=3,  mlp=[128, 128], use_flow=True)

        self.su1 = PointNetSetUpConv(nsample=16, radius=2.4, f1_channel=64, f2_channel=128, mlp=[64, 64], mlp2=[64,64])
        self.flow1_r = RefineFlowRegressor(nsample=16, in_channel=64, feat_channel=128, voxel_size=0.15, resolution=3,  iter_num=1, mlp=[64, 64], feat_mlp=[64, 64], flow_mlp=[64, 64], use_flow=True)
        
        self.su0 = PointNetSetUpConv(nsample=16, radius=2.4, f1_channel=32, f2_channel=64, mlp=[64, 64], mlp2=[64,64])
        self.flow0_r = RefineFlowRegressor(nsample=16, in_channel=64, feat_channel=64, voxel_size=0.15, resolution=3,  iter_num=3, mlp=[64, 64], feat_mlp=[64, 64], flow_mlp=[64, 64], use_flow=True)
    ...
    def forward(self, pc1, pc2, feats1=None, feats2=None):
        ...
        l3_feats, _, l3_flow = self.flow3_r(l3_pc1, l3_pc2, l3_4_feats1, l3_4_feats2, 3)
        ...
        l2_feats_sf, _,  l2_flow = self.flow2_r(l2_pc1, l2_pc2, l2_3_feats1, l2_3_feats2, 5, l2_coarse_sf, l2_3_feats_sf)
        ...
        l1_feats_sf, _, l1_flow = self.flow1_r(l1_pc1, l1_pc2, l1_2_feats1, l1_2_feats2, 7, l1_coarse_sf, l1_2_feats_sf)
        ...
        _, _, flow = self.flow0_r(pc1, pc2, l0_1_feats1, l0_1_feats2, 7, l0_coarse_sf, l0_1_feats_sf)
