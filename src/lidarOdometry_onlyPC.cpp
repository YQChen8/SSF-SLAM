...
void publishResult(){
    ...
    t_0_last = t_0_curr;
//    12032881
//    ROS_INFO_STREAM(std::setprecision(2)<< std::fixed<< "position=(" << 0 << " ," << 0 << ")"  );
...
//        size_t n = sizeof(para_q)/sizeof(para_q[0]);
//
//        //循环遍历数组元素
//        ROS_INFO_STREAM("para_q");
//        for (size_t i = 0; i < n; i++) {
//            ROS_INFO_STREAM(para_q[i] << '  ');
//        }
//        ROS_INFO_STREAM("para_t");
//        n = sizeof(para_t)/sizeof(para_t[0]);
//
//        //循环遍历数组元素
//        for (size_t i = 0; i < n; i++) {
//            ROS_INFO_STREAM(para_t[i] << '  ');
//        }
